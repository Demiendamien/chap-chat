  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    <EyeOff className="size-5 text-primary z-10" />
                  ):(
                    <Eye className="size-5 text-primary z-10" />
                  )}
                </button>
              </div>
            </div>
      ...
      <AuthImagePattern
        ...
        subtitle="connect with friends, share moments, and stay in touch you care about."
      />
